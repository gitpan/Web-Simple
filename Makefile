...
PM_TO_BLIB = lib/Web/Dispatch/ToApp.pm \
	blib/lib/Web/Dispatch/ToApp.pm \
	lib/Web/Simple/DispatchNode.pm \
	blib/lib/Web/Simple/DispatchNode.pm \
	lib/Web/Simple/HackedPlack.pm \
	blib/lib/Web/Simple/HackedPlack.pm \
	lib/Web/Simple/Application.pm \
	...
	lib/Plack/Middleware/Dispatch.pm \
	blib/lib/Plack/Middleware/Dispatch.pm \
	lib/Web/Dispatch/ParamParser.pm \
...
manifypods : pure_all  \
	...
	$(NOECHO) $(POD2MAN) --section=3 --perm_rw=$(PERM_RW) \
	  lib/Web/Simple.pm $(INST_MAN3DIR)/Web::Simple.$(MAN3EXT) \
	  lib/Web/Simple/HackedPlack.pm $(INST_MAN3DIR)/Web::Simple::HackedPlack.$(MAN3EXT) \
	  lib/Web/Simple/Application.pm $(INST_MAN3DIR)/Web::Simple::Application.$(MAN3EXT) 
...
pm_to_blib : $(FIRST_MAKEFILE) $(TO_INST_PM)
	$(NOECHO) $(ABSPERLRUN) -MExtUtils::Install -e 'pm_to_blib({@ARGV}, '\''$(INST_LIB)/auto'\'', q[$(PM_FILTER)], '\''$(PERM_DIR)'\'')' -- \
	  lib/Web/Dispatch/ToApp.pm blib/lib/Web/Dispatch/ToApp.pm \
	  lib/Web/Simple/DispatchNode.pm blib/lib/Web/Simple/DispatchNode.pm \
	  lib/Web/Simple/HackedPlack.pm blib/lib/Web/Simple/HackedPlack.pm \
	  lib/Web/Simple/Application.pm blib/lib/Web/Simple/Application.pm \
	  lib/HTML/Tags.pm blib/lib/HTML/Tags.pm \
	  lib/Web/Dispatch/Node.pm blib/lib/Web/Dispatch/Node.pm \
	  lib/Web/Dispatch/Wrapper.pm blib/lib/Web/Dispatch/Wrapper.pm \
	  lib/CSS/Declare.pm blib/lib/CSS/Declare.pm \
	  lib/Web/Dispatch/Predicates.pm blib/lib/Web/Dispatch/Predicates.pm \
	  lib/XML/Tags.pm blib/lib/XML/Tags.pm \
	  lib/Web/Simple.pm blib/lib/Web/Simple.pm \
	  lib/Web/Dispatch.pm blib/lib/Web/Dispatch.pm \
	  lib/Plack/Middleware/Dispatch.pm blib/lib/Plack/Middleware/Dispatch.pm \
	  lib/Web/Dispatch/ParamParser.pm blib/lib/Web/Dispatch/ParamParser.pm \
	  lib/Web/Dispatch/Parser.pm blib/lib/Web/Dispatch/Parser.pm 
